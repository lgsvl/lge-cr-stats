...
do
    ...
    gitinspector.py --format=html --file-types=*,java,c,cc,cpp,h,py,js,sql,mm,html,txt,gn,md,idl,in,gyp,gypi,bp --hard=false --since="$START_DATE" --until="$now" -T -x "email:^(?!([a-zA-Z0-9._-]+@lge.com))" $CHROMIUM_PATH > $INDEX_ORG_PATH/index-org.html
